...
import {add_experience} from '../../../../store/actions/portfolioActions'


const SubExperience=({ experience, closeForm,...props })=>{
  const dispatch = useDispatch();
  const [value, setValue] = useState(experience);

  const handleSubmit = (evt) => {
    evt.preventDefault();
    dispatch(add_experience(value));
    closeForm();
  };
